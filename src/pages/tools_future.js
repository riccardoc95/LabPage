...
import proj1 from "../../public/images/tools/blank.png";
...
const Tool = ({ title, type, img, link, github }) => {
...
export default function Tools() {
  return (
    <>
      <Head>
        <title>Modern Portfolio Built with Nextjs | Tools Page</title>
        <meta
          name="description"
          content="Discover the latest webapp Tools created by CodeBucks, a Next.js developer with 
