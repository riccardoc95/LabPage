...
export const TwitterIcon = ({ className, ...rest }) => (
    ...
    >
        <path
            fill="currentColor"
            d="M714.163 519.284 1160.89 0H1052.64L670.95 442.001 369.75 0H0l468.908 681.821L0 1226.27h108.25l401.1-476.54 316.401 476.54H1200L714.137 519.284h.026ZM557.602 687.828l-46.498-66.776-369.75-530.04h158.97l298.542 427.831 46.498 66.775 392.726 563.344h-158.97L557.602 687.828Z"
        />
    </svg>
);
